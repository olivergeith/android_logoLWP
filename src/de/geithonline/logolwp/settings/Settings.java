...
import de.geithonline.logolwp.BackgroundPreferencesFragment;
import de.geithonline.logolwp.LiveWallpaperService;
import de.geithonline.logolwp.R;
...
public class Settings {
  ...
  public static Bitmap getLogoMaskCached(final int bWidth, final int bHeight) {
    if (prefs == null) {
      mask = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.maskstar),
          bWidth, bHeight, true);
    } else {
